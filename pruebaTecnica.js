// Propiedad intelectual: Esta prueba fue desarrollada por TCIT el año 2014 y registrada bajo
//propiedad intelectual, cualquier publicación o difamación podría estar sujeta a acciones legales.
//Hay otras empresas que nos han copiado esta prueba, no aceptes imitaciones, exige el original
//xD
// No realizar la prueba en repl.it al hacerlo su respuesta queda disponible para otros
//postulantes, tampoco subirla a repositorios de github públicos
...
function listPaddockManagersByName() {
    const ruts = paddockManagers.map(function(paddockManager){
...
//(la concatenación tiene un separador de guión ‘-’, por ejemplo AVELLANOS-2020) y el valor
//otro objeto en el cual la clave sea el id del administrador y el valor el nombre del
//administrador
